User.create!([
  {email: "le.tat.tung@framgia.com",
  password: "tung123", password_confirmation: "tung123",
  role: "user", name: "Le Tat Tung", staff_code: "20132900"},
  {email: "le.vinh.thien@framgia.com",
  password: "thien123", password_confirmation: "thien123",
  role: "user", name: "Le Vinh Thien", staff_code: "20132901"},
  {email: "le.dinh.phuc@framgia.com",
  password: "phuc123", password_confirmation: "phuc123",
  role: "admin", name: "Le Dinh Phuc", staff_code: "20132902"},
  {email: "vu.thu.hien@framgia.com",
  password: "hien123", password_confirmation: "hien123",
  role: "admin", name: "Vu Thu Hien", staff_code: "20132903"},
  {email: "pham.huu.duc@framgia.com",
  password: "duc123", password_confirmation: "duc123",
  role: "user", name: "Pham Huu Duc", staff_code: "20132904"},
  {email: "tran.thi.dieu.linh@framgia.com",
  password: "linh123", password_confirmation: "linh123",
  role: "user", name: "Tran Thi Dieu Linh", staff_code: "20132905"},
  {email: "phan.hoang.minh@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "user", name: "Phan Hoang Minh"},
  {email: "mai.trung.nghia@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "user", name: "Mai Trung Nghia"},
  {email: "nguyen.van.nhan@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "user", name: "Nguyen Van Nhan"},
  {email: "norifumi.homma@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "admin", name: "Norifumi Homma"},
  {email: "shinichi.yoshida@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "user", name: "Shinichi Yoshida"},
  {email: "soma.ichikawa@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "user", name: "Soma Ichikawa"},
  {email: "vu.thuy.trang@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "user", name: "Vu Thuy Trang"},
  {email: "tran.ba.trong@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "admin", name: "Tran Ba Trong"},
  {email: "yutaka.narasaki@framgia.com",
  password: "framgiajapan", password_confirmation: "framgiajapan",
  role: "user", name: "Yutaka Narasaki"}
])
...
BookTag.create!([
  ...
  {book_id: 10, tag_id: 1},
  {book_id: 10, tag_id: 2},
  {book_id: 11, tag_id: 20},
  {book_id: 12, tag_id: 3},
  {book_id: 12, tag_id: 16},
  {book_id: 13, tag_id: 3},
  {book_id: 13, tag_id: 20},
  {book_id: 14, tag_id: 3},
  {book_id: 14, tag_id: 20},
  {book_id: 15, tag_id: 3},
  {book_id: 15, tag_id: 20},
  {book_id: 16, tag_id: 21},
  {book_id: 17, tag_id: 21},
  {book_id: 18, tag_id: 21},
  {book_id: 19, tag_id: 21},
  {book_id: 20, tag_id: 22},
  {book_id: 21, tag_id: 21},
  {book_id: 22, tag_id: 4},
  {book_id: 22, tag_id: 5},
  {book_id: 23, tag_id: 15},
  {book_id: 24, tag_id: 20},
  {book_id: 25, tag_id: 20},
  {book_id: 26, tag_id: 12},
  {book_id: 26, tag_id: 19},
  {book_id: 27, tag_id: 15},
  {book_id: 27, tag_id: 16},
  {book_id: 27, tag_id: 17},
  {book_id: 27, tag_id: 18},
  {book_id: 28, tag_id: 7},
  {book_id: 29, tag_id: 1},
  {book_id: 29, tag_id: 9},
  {book_id: 30, tag_id: 1},
  {book_id: 30, tag_id: 9},
  {book_id: 30, tag_id: 15},
  {book_id: 30, tag_id: 16},
  {book_id: 31, tag_id: 20},
  {book_id: 32, tag_id: 20},
  {book_id: 33, tag_id: 15},
  {book_id: 33, tag_id: 20},
  {book_id: 34, tag_id: 3},
  {book_id: 35, tag_id: 3},
  {book_id: 36, tag_id: 3},
  {book_id: 37, tag_id: 9},
  {book_id: 38, tag_id: 24},
  {book_id: 39, tag_id: 23},
  {book_id: 40, tag_id: 3},
  {book_id: 40, tag_id: 5},
  {book_id: 41, tag_id: 24},
  {book_id: 42, tag_id: 21},
  {book_id: 43, tag_id: 20},
  {book_id: 43, tag_id: 21},
  {book_id: 44, tag_id: 3},
  {book_id: 44, tag_id: 4},
  {book_id: 44, tag_id: 5},
  {book_id: 45, tag_id: 15},
  {book_id: 45, tag_id: 21},
  {book_id: 46, tag_id: 20},
  {book_id: 47, tag_id: 24},
  {book_id: 48, tag_id: 25},
  {book_id: 49, tag_id: 3},
  {book_id: 50, tag_id: 3},
  {book_id: 51, tag_id: 25},
  {book_id: 52, tag_id: 25},
  {book_id: 53, tag_id: 21},
  {book_id: 54, tag_id: 4},
  {book_id: 54, tag_id: 5},
  {book_id: 55, tag_id: 12},
  {book_id: 55, tag_id: 19},
  {book_id: 56, tag_id: 12},
  {book_id: 56, tag_id: 19},
  {book_id: 57, tag_id: 11},
  {book_id: 57, tag_id: 19},
  {book_id: 58, tag_id: 20},
  {book_id: 58, tag_id: 25},
